...
const PARAM_DEFS = [
  ...
  },
  {
    ...
    type: "chips",
    def: "circle",
    options: ["circle", "ellipse", "square", "diamond", "cross", "engrave", "line"],
    optionLabels: {
      circle: "Circle",
      ellipse: "Ellipse",
      square: "Square",
  ...
  },
  {
    ...
    unit: "%",
    hint:
      "Undulate each row of dots, as a percentage of the cell. Neighbouring " +
      "cells move together, so a line screen becomes one continuous wavy line " +
      "- the engraved banknote look. Works with any shape.",
  },
  {
    key: "waveLength",
    label: "Wavelength",
    ...
    def: 12,
    unit: " cells",
    showIf: (p) => p.waveAmount > 0,
    hint: "How many cells one wave takes.",
  },
  {
    key: "dotGain",
    label: "Dot Gain",
